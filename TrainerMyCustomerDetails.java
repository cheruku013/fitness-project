...
@WebServlet(urlPatterns = "/trainerMyCustomerDetails")
public class TrainerMyCustomerDetails extends HttpServlet{
			...
			throws ServletException,IOException
	{
		...
		{	
			...
			try {
				...
				request.getRequestDispatcher("/WEB-INF/views/trainerMyCustomerDetails.jsp").forward(request, response);
