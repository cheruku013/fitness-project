...
<!-- NAV SECTION -->
	...
	<br><br>
	<br>	
	<h2 align="center" style="color: red">Assigned Customer Details</h2>
	<br>
	<table id="t01" style="width: 100%">
		...
		<c:forEach var="custRecords" items="${customerRecords}">
			<tr>
				...
				<td>
					<a href="trainerUpdateCustomerDiet?custID=${custID}">Update</a>
					<a href="trainerUnassignCustomer?custID=${custID}">Unassign</a>
				</td>
			</tr>
		</c:forEach>
