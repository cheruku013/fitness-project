	...
	<div class="navbar navbar-inverse navbar-fixed-top"
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #660c0c"><img
					src="img/fitLogo.png" width="50" height="50""> Fitness
					Center</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="welcome"><img src="img/homeLogo.png"
							width="40" height="40"></a></a></li>
					<li><a href="login"><img src="img/loginLogo1.png"
							width="45" height="45"></a></li>
					<li><a href="register"><img src="img/registerLogo1.png"
