	...
	<div class="form">
      ...
      <div >
        <div id="signup">
          ...
          <form action="/trainerUpdateCustomerDiet" method="post">
          ...
          document.getElementById("diet").value = "${custDiet}";
          document.getElementById("workout").value = "${custWorkOut}";
          </script>
          <button type="submit" class="button button-block"/>Update Diet</button>
